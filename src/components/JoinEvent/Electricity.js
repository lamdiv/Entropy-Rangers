...
function Electricity(props) {
  ...
  return (
    ...
    <div className="mt-12 flex flex-col">
        <h1 className="text-2xl font-semibold text-dark">Electricity Usage</h1>
        <p className="text-md text-dark">
          Lorem ipsum dolor sit amet, onsectetur adipiscing elit.{" "}
        </p>
        <div className="flex items-center text-center space-x-5 mt-5 ">
          <div onClick={(e)=>props.onChange(e,{electricity:'Renewable'})} className={props.values.electricity==='Renewable'?activeClass:inactiveClass}>
            <svg
              width="20"
              height="25"
              viewBox="0 0 41 55"
          ...
          <div onClick={(e)=>props.onChange(e,{electricity:'Non Renewable'})} className={props.values.electricity==='Non Renewable'?activeClass:inactiveClass}>
            <svg
              width="20"
              height="25"
              viewBox="0 0 41 55"
