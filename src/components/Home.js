...
function Home() {
  ...
  const { data, error, isPending } = useFetch('https://co2-calculator-sahajrajmalla.herokuapp.com/events?skip=0&limit=100');
      ...
      <section className="mt-16">
        <div className="container mx-auto px-2 md:px-0">
          ...
          <div className="w-full space-y-10">
            ...
            {data && <div className=" flex flex-col space-y-10 mx-auto md:flex-row md:space-y-0 md:space-x-10 ">
              {/* <!--  Image --> */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center md:justify-start space-x-2 text-primary items-center">
                    ...
                    <div className="flex space-x-1 items-center">
                      ...
                      <p className="text-sm lg:text-md">{data[0].event_date}, {data[0].event_time}</p>
                    </div>
                  </div>
            ...
            {data && data.splice(1).map(item=>(
              ...
              <div className="flex flex-col justify-between space-y-6 text-center md:text-start">
                <div className="space-y-2">
                  <Link to={`/event/${item.id}`} className="text-xl font-semibold text-primary cursor-pointer ">
                    {item.name}
                  </Link>
                  <p className="text-md text-dark">{item.address}</p>
                  <p className="text-sm text-dark">{item.event_date}, {item.event_time}</p>
                </div>
              </div>
            </div>
            ))}
